...
#ifndef DESTOR_H_ //=if not defined,∑¿÷π÷ÿ∏¥±‡“ÎªÚ∞¸∫¨
#define DESTOR_H_
...
#include "utils/sds.h"
//#include "./picture_dedup/pic_destor.h"

#include "./picture_dedup/pic_file_compre_and_decompre.h"
...
#define SQUARE_HASH_SIZE 10
/* «∑Ò∆Ù”√Õº∆¨»•÷ÿ*/
#define PIC_CHUNK_YES_OR_NO 1
#define LZO_YES_OR_NO 0
/*
#define CHUNK_PICTURE_UNIQUE (0x2000)//Œ®“ªÕº∆¨øÈ
#define CHUNK_PICTURE_DUPLICATE (0x4000)
*/

/* states of normal chunks. */
#define CHUNK_UNIQUE (0x0000)//Œ®“ªøÈ
#define CHUNK_DUPLICATE (0x0100)//»ﬂ”‡øÈ
